                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td class="esd-block-text" align="right">
                                                                                                                        <p><a target="_blank" style="font-size: 18px; line-height: 120%;" href="https://stripo.email/">Shop</a></p>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                                        <p style="font-size: 16px; color: #777777;">Welcome to Beretun and thanks for signing up! You're one step closer to purchasing the finest goods that we have to offer.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t" align="center">
                                                                                        <p style="font-size: 16px; color: #777777;">Please confirm your</p>
                                                                                        <p style="font-size: 16px; color: #777777;">email address to get started.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p30t es-p15b" align="center"> <span class="es-button-border" style="background: rgb(237, 142, 32) none repeat scroll 0% 0%;"> <a href="https://stripo.email/" class="es-button" target="_blank" style="font-weight: normal; border-width: 15px 30px; background: rgb(237, 142, 32) none repeat scroll 0% 0%; border-color: rgb(237, 142, 32); color: rgb(255, 255, 255); font-size: 18px;">Confirm account</a> </span> </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                                        ...
                                                                                        <table class="es-menu" width="40%" cellspacing="0" cellpadding="0" align="center">
                                                                                            <tbody>
                                                                                                <tr class="links-images-top">
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " id="esd-menu-id-0" width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href="https://stripo.email/"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/60961522067175378.png" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " id="esd-menu-id-1" esdev-border-color="#000000" esdev-border-style="solid" width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href="https://stripo.email/"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/72681522067183042.png" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " id="esd-menu-id-2" esdev-border-color="#000000" esdev-border-style="solid" width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href="https://stripo.email/"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/76121522068412489.jpg" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " id="esd-menu-id-3" esdev-border-color="#000000" esdev-border-style="solid" width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href="https://stripo.email/"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/12411522072775563.jpg" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c es-p5b" esdev-links-color="#777777" align="left">
                                                                                        <p style="color: #777777;">If you didn't create an account using this email address, please ignore this email or&nbsp;<u><a target="_blank" style="color: #777777;">unsubscribe</a></u>.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-infoblock" align="center">
                                                                                        <a target="_blank" href="http://stripo.email/?utm_source=templates&utm_medium=email&utm_campaign=accessory&utm_content=trigger_newsletter5"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_9df86e5b6c53dd0319931e2447ed854b/images/64951510234941531.png" alt="" width="125"> </a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
